...
unsigned char options[] = {0b01110111, 0b00010100, 0b10110011, 0b10110110, 0b11010100, 0b11100110, 0b11100111, 0b00110100, 0b11110111, 0b11110110, 0b11110101, 0b11000111, 0b01100011, 0b10010111, 0b11100011, 0b11100001};
...
static int start_400ms = 65536 - 50000;


static __attribute__((inline)) void tmr1_load_400ms(void) {
    TMR1 = start_400ms;
}

static __attribute__((inline)) int get_mics() {
    return (TMR1 - start_400ms)*8;
}
